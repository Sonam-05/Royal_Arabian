...
export const mockDestination: Destination = {
  _id: "china_destination_mock",
  _type: "destination",
  name: "China",
  slug: { current: "cn" },
  tagline: "Explore the Land of the Dragon",
  heroImage: "https://images.unsplash.com/photo-1508672019048-805c876b67e2?auto=format&fit=crop&w=1920&q=80",
...
export const mockPackages: PackageWithDestination[] = [
  {
    _id: "pkg1_mock",
    _type: "package",
    name: "China Highlights Tour",
    slug: { current: "china-highlights-tour" },
  ...
  },
  {
    ...
    slug: { current: "imperial-wonders-pandas" },
    destination: mockDestination,
    ...
    heroImage: "https://images.unsplash.com/photo-1547989453-11e67ffb3885?auto=format&fit=crop&w=1200&q=80",
    included: [
    ...
    itinerary: [
      ...
      },
      {
        _key: "it2_5",
        day: 5,
        title: "Terracotta Army & City Wall",
  ...
  },
  {
    ...
    slug: { current: "sichuan-yangtze-cruise" },
    destination: mockDestination,
